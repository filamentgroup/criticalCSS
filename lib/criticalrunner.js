...
(function(){
	...
	if( typeof cookies === "string" && cookies !== "undefined" ){
		var cookieList = JSON.parse( cookies );
	...
	page.open(  site, function( status ){
		if( status === "success" ){
			...
			if( crit.length === 0 ){
				...
				system.stdout.write(JSON.stringify(output));
				phantom.exit();
			}
		} else {
